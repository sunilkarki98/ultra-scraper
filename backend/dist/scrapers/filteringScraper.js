...
exports.FilteringScraper = void 0;
 ...
 */
class FilteringScraper extends baseScraper_1.BaseScraper {
    ...
    async scrape(options) {
        ...
        const universalScraper = new universalScraper_1.UniversalScraper(this.proxyService);
        ...
        logger_1.logger.info(`Applying LLM filtering for ${this.page.url()}`);
        ...
        try {
            ...
            logger_1.logger.error(`LLM filtering failed: ${error.message}`);
...
exports.FilteringScraper = FilteringScraper;
